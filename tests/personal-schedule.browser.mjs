...
try {
  ...
  await page.addStyleTag({ content: '.personal-day-track{height:450px;width:140px;position:relative}.personal-card{position:absolute}.personal-new-range{position:absolute;pointer-events:none}' });
