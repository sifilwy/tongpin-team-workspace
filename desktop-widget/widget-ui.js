...
document.addEventListener('DOMContentLoaded', () => {
  ...
  <div class="menu" hidden><button data-command="refresh">刷新日程</button><button data-command="reset">恢复右侧位置</button><button data-command="collapse">收起为小圆点</button><button data-command="close">退出组件</button></div>`;
